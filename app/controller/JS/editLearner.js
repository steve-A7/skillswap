document.addEventListener("DOMContentLoaded", function () {
	...
	var form = document.getElementById("editLearnerForm");
	...
	function snapshotState() {
		...
		var inputs = document.querySelectorAll("#editLearnerForm input");
		...
		var textareas = document.querySelectorAll("#editLearnerForm textarea");
		for (var t = 0; t < textareas.length; t++) {
			var ta = textareas[t];
			snap.values[ta.id || ta.name || "ta_" + t] = ta.value;
		}

		var selects = document.querySelectorAll("#editLearnerForm select");
	...
	var catBox = document.getElementById("learnerInterestsBox");
	if (catBox) {
	...
	function setEditing(on) {
		...
		var els = document.querySelectorAll(
			"#editLearnerForm input, #editLearnerForm textarea",
		);
	...
	var guard = document.querySelectorAll(
		"#editLearnerForm input, #editLearnerForm textarea, #editLearnerForm select",
	);
